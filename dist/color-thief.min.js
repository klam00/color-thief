 ...
 *
 */
!function(a){var b=function(a){if("string"==typeof a){var b=a;a=new Image,a.src=b}this.canvas=document.createElement("canvas"),this.context=this.canvas.getContext("2d"),document.body.appendChild(this.canvas),this.width=this.canvas.width=a.width,this.height=this.canvas.height=a.height,this.context.drawImage(a,0,0,this.width,this.height)};b.prototype.clear=function(){this.context.clearRect(0,0,this.width,this.height)},b.prototype.update=function(a){this.context.putImageData(a,0,0)},b.prototype.getPixelCount=function(){return this.width*this.height},b.prototype.getImageData=function(){return this.context.getImageData(0,0,this.width,this.height)},b.prototype.removeCanvas=function(){this.canvas.parentNode.removeChild(this.canvas)};var c=function(){};/*!
